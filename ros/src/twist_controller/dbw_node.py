...
class DBWNode(object):
    ...
    def loop(self):
        ...
        while not rospy.is_shutdown():
            ...
            if not None in [self.current_velocity,self.ang_vel,self.linear_vel]:
                self.throttle, self.brake, self.steering = self.controller.control(self.current_velocity,self.dbw_enabled_status,self.linear_vel,self.ang_vel)
    ...
    def twist_cb(self,twist):
        ...
        self.ang_vel = twist.twist.angular.z
